...
export const ko: Record<TranslationKey, string> = {
  ...
  "connection.afterLaunchHint": "로그인을 마친 뒤 '완료 후 새로고침'을 눌러주세요.",
  ...
  "connection.launchCli": "터미널에서 로그인",
  ...
  "provider.detailSubtitle": "이 프로바이더의 상세 사용 지표입니다.",
  "settings.about.description": "Codex, Claude, Copilot, OpenRouter 사용량을 한 곳에서 확인하세요.",
